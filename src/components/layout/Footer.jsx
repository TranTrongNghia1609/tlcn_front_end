        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/contests" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Kỳ thi
                </Link>
              </li>
              <li>
                <Link to="/leaderboard" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Bảng xếp hạng
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/feedback" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Góp ý
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/cookies" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Chính sách Cookie
                </Link>
              </li>
              <li>
                <Link to="/guidelines" className="text-gray-600 hover:text-blue-600 transition-colors text-sm">
                  Quy tắc cộng đồng
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-300 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              ...
              <Link to="/accessibility" className="text-gray-600 hover:text-blue-600 transition-colors">
                Truy cập
              </Link>
              <span className="text-gray-400">•</span>
